...
namespace Vessel
{
    ...
    internal class Program
    {
        ...
        public static List<Vessel> ReadVesselData(string filename)
        {
            if (R == 7)
            {
                ...
                //                new int[]{ 6, 0 }, new int[]{ 3, 6, 5 }, new int[]{ 1, 5 }, new int[]{ 0, 3, 4 } };// 7个料条  unavailable 
                ...
                //                Rk = new int[15][]
                //{
                //                                    new int[]{ 0, 1, 2 }, // 0  原来3个 -> 现在仍3个
                //                                    new int[]{ 3, 4, 5 }, // 1
                //                                    new int[]{ 6, 0, 1 }, // 2
                //                                    new int[]{ 0, 1 },    // 3  原来2个 -> 现在仍2个
                //                                    new int[]{ 2, 3, 4 }, // 4
                //                                    new int[]{ 5, 6, 0 }, // 5
                //                                    new int[]{ 2, 3 },    // 6
                //                                    new int[]{ 4, 5 },    // 7
                ...
                Rk = new int[][]
  {
    ...
    new int[]{ 0, 3, 4 }
                ...
                //Rk = new int[15][] { new int[]{ 1, 5, 6 }, new int[] { 1, 3, 5 }, new int[] { 2, 4, 6 }, new int[] { 3, 5, 7 }, new int[] { 0, 4, 6 },
                //                new int[]{ 3, 5, 6}, new int[]{ 0, 2 ,8}, new int[]{ 3, 6, 7 }, new int[]{ 5, 1, 8 }, new int[]{ 2, 6, 7 }, new int[]{ 1, 6, 8 },
                //                new int[]{ 6, 0 }, new int[]{ 3, 6, 5 }, new int[]{ 1, 5 }, new int[]{ 0, 3, 4 } };//9个料条   9料条
        ...
        public static (Vessel resSP, double rdCost) SubproblemCplex(Vessel v, List<inherit_info> addconstraints = null)
        {
            ...
            //subsolver.SetParam(Cplex.Param.Threads, 16);
            ...
            while (true)
            {
                ...
                for (int i = 0; i < N; i++)
                {
                    ...
                    else
                    {
                        ...
                        //{
                        //	if (cplexTest.rdCost == 0 && spResLS.cost == int.MaxValue)
                        //	{ 
        ...
        public static double heurCplexSpend;
        static void Main(string[] args)
        {
            timer = DateTime.Now;
            conflictDataPath = /*"C:\\Users\\yang_\\Desktop\\conflictData9.txt";*/
            // "C:\\Users\\yang_\\Pictures\\IBYP-main\\conflictData\\conflictDataMore.txt";
            "C:\\Users\\yang_\\Pictures\\IBYP-main\\conflictData\\conflictData7.txt";

            List<Vessel> initialVessels = ReadVesselData("C:\\Users\\yang_\\Desktop\\Data\\vesselData\\3\\hard\\5" +
                ".txt");
            ...
            while (conflictVessels.Item1.Count != 0)
            {
                ...
                DateTime heurCplexBegin = DateTime.Now;
                var tempRes = SubproblemCplex(temp, forbid);
                DateTime heurCplexEnd = DateTime.Now;
                heurCplexSpend+= (heurCplexEnd - heurCplexBegin).TotalSeconds;
            ...
            Console.WriteLine((now2 - initialSolBegin).TotalSeconds);
